...
//    bool refindStrategy = parser.has("rs");
    ...
    bool readOk = readCameraParameters("/Users/grashin/video_detection/calibration_2.yaml", camMatrix, distCoeffs);
    if(!readOk) {
    ...
    String video;
    if(true) {
        video = "/Users/grashin/video_detection/aruco_video_4.mp4";
    }
...
//                                         distCoeffs);
        ...
        if(true && rejected.size() > 0) //showrejected
